...
Route::get('/dashboard/view-end-user-booking-booking/{id}', [App\Http\Controllers\BookingController::class, 'bookingEndUserDataDetail'])->name('bookingEndUserDataDetail');
